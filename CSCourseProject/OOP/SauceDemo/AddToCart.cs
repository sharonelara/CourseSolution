...
namespace CSCourseProject.OOP.SauceDemo
{
    ...
    public class AddToCart
    {
        ...
        [TestCase(Item SLBackpack = new Item
        {
            itemName = "Sauce Labs Backpack",
            itemDesc = "carry.allTheThings() with the sleek, streamlined Sly Pack that melds uncompromising style with unequaled laptop and tablet protection.",
            itemPrice = 29.99,
            itemImage = "https://www.saucedemo.com/static/media/sauce-backpack-1200x1500.34e7aa42.jpg",
            hasAddToCart = true
        };)]

        public void Cart2(Item item)
        {
            //Less repetitive test case method:
            //string a = "add-tocart";
            //string b = a + ItemName;
